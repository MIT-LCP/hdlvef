...
select ec.subject_id
    ...
    , case 
      when et.no_vasopressors = 0 then 0
      else 1 
    end as vasopressor
    , case
      when et.no_vasopressors is null then 0
      else et.no_vasopressors 
    end as no_vasopressors
    , case
      when et.auc_vasopressor_dose is null then 0
      else et.auc_vasopressor_dose
